...
class ParticleFilter {  
 ...
 private:
  ...
  std::vector<LandmarkObs> predict_landmark(std::vector<Map::single_landmark_s> landmark_list, Particle particle, double sensor_range);
  std::vector<LandmarkObs> transform_observations(const std::vector<LandmarkObs> &observations,  Particle particle);
};
